...
$testEnv = [
	...
	'MYSQL_USER' => getenv('MYSQL_USER') !== false && getenv('MYSQL_USER') !== '' ? getenv('MYSQL_USER') : 'kytarna',
	'MYSQL_PASSWORD' => getenv('MYSQL_PASSWORD') !== false && getenv('MYSQL_PASSWORD') !== '' ? getenv('MYSQL_PASSWORD') : 'kytarna',
	...
	'REDIS_PASSWORD' => getenv('REDIS_PASSWORD') !== false && getenv('REDIS_PASSWORD') !== '' ? getenv('REDIS_PASSWORD') : 'kytarna',
	...
	'RABBITMQ_USER' => getenv('RABBITMQ_USER') !== false && getenv('RABBITMQ_USER') !== '' ? getenv('RABBITMQ_USER') : 'kytarna',
	...
	'PROXY_HOST' => 'test.local',
	'PROXY_PORT_SSL' => '443',
	'LECTURE_FILE_MAX_SIZE_MB' => '1',
	'MCP_SESSION_TTL' => '60',
...
if ($database === 'kytarna') {
	fwrite(
		STDERR,
		"Refusing to run tests against the production database 'kytarna'. "
		. "Set TEST_MYSQL_DATABASE to a dedicated test database (default: kytarna_test).\n",
	);
	exit(1);
}
