...
final readonly class CoursePrefixGenerator implements CoursePrefixGeneratorInterface
{
	...
	public function generate(Workspace $workspace, string $name, ?int $excludeCourseId): string
	{
		...
		$taken = array_flip($this->courseRepository->findPrefixesInWorkspace($workspace->id, $excludeCourseId));
