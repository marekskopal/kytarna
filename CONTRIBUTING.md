# Contributing to Kytarna

Thanks for considering a contribution. Kytarna is MIT-licensed and built in the
...
- **Security**: please **don't** file a public issue. Open a
  [private security advisory](https://github.com/marekskopal/kytarna/security/advisories/new)
